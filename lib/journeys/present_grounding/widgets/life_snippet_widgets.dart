...
Future<void> showLifeModerationSheet({
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 18),
              _ModerationToggle(
                asset: LifeSnippetAssets.report,
                selected: _report,
                onTap: () => setState(() => _report = !_report),
              ),
              const SizedBox(height: 10),
              _ModerationToggle(
                asset: LifeSnippetAssets.block,
                selected: _block,
              ...
              GestureDetector(
                ...
                child: AnimatedOpacity(
                  ...
                  opacity: (_report || _block) && !_submitting ? 1 : 0.45,
                  child: Image.asset(
                    LifeSnippetAssets.confirm,
                    width: 168,
                    height: 38,
                    fit: BoxFit.fill,
                    filterQuality: FilterQuality.high,
